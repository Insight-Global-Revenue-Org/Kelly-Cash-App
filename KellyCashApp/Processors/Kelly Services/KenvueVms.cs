...
{
    internal static class KenvueVms
    {
        public static Dictionary<string, KenvueVmsMatch> Import(
            string filePath)
        {
            ...
            var matches =
                new Dictionary<string, KenvueVmsMatch>(
                 ...
                 row++)
            {
                string parentInvoiceId =
                    worksheet.Cell(row, parentInvoiceIdCol)
                        .GetString()
                        .Trim();
                ...
                if (string.IsNullOrWhiteSpace(parentInvoiceId) ||
    ...
    IXLWorksheet worksheet)
        {
            ...
            throw new Exception(
                "Could not find the Kenvue VMS headers " +
                "'Parent Invoice ID' and 'Fee Description'.");
        }
            ...
            bool throwIfMissing = true)
        {
            ...
            {
                throw new Exception(
                    $"Could not find required Kenvue VMS column: {headerName}");
            }
