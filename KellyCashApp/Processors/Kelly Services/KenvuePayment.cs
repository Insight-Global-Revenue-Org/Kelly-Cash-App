...
namespace KellyCashApp.Processors.Kelly_Services
{
    internal static class KenvuePayment
    {
        ...
        public static string Process(
            ...
            Dictionary<string, KenvueVmsMatch>? vmsMatches = null)
        {
            // ---------------------------------------------------------
            // Find required Kenvue payment columns.
            // Headers are always on row 1.
            // ---------------------------------------------------------

            int invoiceCol = FindColumn(
                worksheet,
                HeaderRow,
                "Invoice");
            ...
            {
                throw new Exception(
                    "Missing one or more required Kenvue payment columns.");
            }
            ...
            var outputRows = new List<KenvueOutputRow>();
            ...
            // ---------------------------------------------------------
            // Process each Kenvue payment row.
            // ---------------------------------------------------------
            ...
            string outputPath =
                    GetUniqueOutputPath(
                        downloadsPath,
                        $"Kenvue {processedDate} - {formattedTotal}.xlsx");

            workbook.SaveAs(outputPath);

            Analytics.LogRemittanceRun(
                $"Kenvue - {formattedTotal}");
            ...
            decimal targetAmount)
        {
            ...
            // is closest to the Kenvue LineTotal.
            OirLookupRow? bestMatch =
                possibleMatches
                    .OrderBy(x =>
                        Math.Abs(
            ...
            // Closest invoice still has to fall inside 40%.
